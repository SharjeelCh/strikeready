...
import automation from "../../assets/usecases/automation.svg";
  ...
  <div className="gap-y-5 sm:gap-y-10 flex items-center justify-center flex-col">
   ...
   <div className="flex flex-col sm:flex-row gap-5 sm:gap-10 items-start justify-center sm:mt-4 sm:justify-between w-full max-w-[1200px] px-3 sm:px-0">
    <div className="w-full px-4 py-2 flex  justify-center">
     ...
     >
      <li>Reduce the burden of security teams by efficiently managing operational tasks</li>
      <li>Improve productivity and lessen team burnout</li>
      <li>Accelerate average time to resolution (MTTR) by up to 80%</li>
     </ul>
    </div>
    <img src={automation} alt="" style={{ verticalAlign: "middle", maxWidth: "100%", outline: "none" }} />
   </div>
  </div>
 );
}
