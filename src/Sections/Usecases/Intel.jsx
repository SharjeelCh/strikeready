...
import intel from "../../assets/usecases/intel.svg";
 ...
 return (
  <div className="gap-y-5 sm:gap-y-10 flex items-center justify-center flex-col">
   ...
   <h2 className="text-lg sm:text-2xl sm:mx-48" style={{ fontFamily: "Inter" }}>
    StrikeReady empowers security teams to proactively identify and mitigate emerging threats through autonomous integration and contextualizing threat
    intelligence.{" "}
   </h2>
   ...
   <div className="flex flex-col sm:flex-row gap-5 sm:gap-10 items-start justify-center sm:mt-4 sm:justify-between w-full max-w-[1200px] px-3 sm:px-0">
    <div className="w-full px-4 py-2 flex  justify-center">
     ...
     >
      <li>Operationalizes threat intelligence in seconds</li>
      <li>Accelerate threat identification and response in seconds</li>
      <li>Speed the analysis of IOCs across 25+ industry-leading analysis engines</li>
     </ul>
    </div>
    <img src={intel} alt="" style={{ verticalAlign: "middle", maxWidth: "100%", outline: "none" }} />
   </div>
  </div>
 );
}
